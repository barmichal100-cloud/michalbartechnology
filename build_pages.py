...
service_page("/services/automation","services/automation.html",
    ...
    "אוטומציה של תהליכים עסקיים בשילוב סוכני AI – חיבור מערכות וכלים כך שפעולות ידניות חוזרות קורות מעצמן וחוסכות שעות עבודה.",
    "אוטומציה וסוכני AI",
    ...
    ["מיפוי תהליכים והזדמנויות לאוטומציה","סוכני AI למשימות ותהליכים","אוטומציות עבודה שוטפות","חיבור בין כלים ומערכות (אינטגרציות ו-API)","דוחות, טפסים ועדכונים אוטומטיים","ייעול תפעולי וחיסכון בזמן"],
    ...
    [("מה זה אוטומציה עסקית?","חיבור בין הכלים והמערכות שלכם כך שפעולות ידניות חוזרות קורות מעצמן – בלי טעויות ובלי לגזול זמן."),
     ("מה זה סוכני AI ואיך הם עוזרים לעסק?","סוכני AI הם עוזרים חכמים שמבינים הקשר ומבצעים משימות שלמות בשבילכם – מענה לפניות, סיווג וניתוב מידע, סיכומים, הפקת תוכן ועוד. בניגוד לאוטומציה שמריצה חוקים קבועים, סוכן AI יודע להתמודד גם עם מצבים לא צפויים."),
    ...
    "אוטומציה וסוכני AI",
    "אוטומציה של תהליכים עסקיים בשילוב סוכני AI – חיבור מערכות וייעול שחוסך שעות עבודה.")
