...
FOOTER = '''<footer class="site-footer">
  <div class="wrap footer-inner">
    ...
    <div class="footer-col">
      <h4>שירותים</h4>
      <a href="/services/product-development">פיתוח מוצרים</a>
      <a href="/services/consulting">ייעוץ עסקי וטכנולוגי</a>
      <a href="/services/automation">אוטומציה ותהליכים</a>
...
CTA = '''  <section class="wrap">
    <div class="cta">
      <h2>יש לכם אתגר, רעיון או פרויקט?</h2>
      <p>שיחת היכרות ראשונית – ללא התחייבות</p>
      <div class="cta-row"><a class="btn1" href="/contact">בואו נדבר →</a><a class="btn2" href="/services">לכל השירותים</a></div>
    </div>
  </section>'''
...
svc_cards = '''  <section class="wrap page-hero">
    ...
    <h1 class="s-head">פיתוח, ייעוץ ואוטומציה – מקצה לקצה</h1>
    <p class="s-lead">משלבת אסטרטגיה, אפיון מדויק, פיתוח ואוטומציה בליווי אישי מההתחלה ועד התוצאה. שלושה תחומים, גישה אחת: להבין את הצורך השורשי ולבנות את הפתרון הנכון.</p>
  </section>
  <section class="wrap">
    <div class="cards">
      <a class="card" href="/services/product-development">
        ...
        <h3>פיתוח מוצרים</h3>
        <p>מאפיון ראשוני ועד מערכת מלאה – עיצוב ופיתוח מקצה לקצה של מוצרים, אתרים ואפליקציות.</p>
        <ul><li>אפיון ועיצוב מוצר</li><li>פיתוח מוצרים ומערכות</li><li>אתרים ואפליקציות · MVP</li></ul>
        <span class="go">לפרטים ↗</span>
      </a>
      <a class="card" href="/services/consulting">
        <div class="ic">◆</div>
        <h3>ייעוץ עסקי וטכנולוגי</h3>
        <p>הבנת הצורך השורשי ובניית פתרון מדויק – בעולמות הלקוח, הביזנס והטכנולוגיה.</p>
        <ul><li>מיפוי צרכים וכאבים</li><li>אסטרטגיה ותהליכים</li><li>ליווי קבלת החלטות</li></ul>
        <span class="go">לפרטים ↗</span>
      </a>
      <a class="card" href="/services/automation">
        <div class="ic">⚙</div>
        <h3>אוטומציה ותהליכים</h3>
        <p>תהליכים חכמים שחוסכים זמן ידני ועובדים לבד – חיבור מערכות וייעול תפעולי.</p>
        <ul><li>אוטומציות עבודה</li><li>חיבור כלים ומערכות</li><li>ייעול תפעולי</li></ul>
        <span class="go">לפרטים ↗</span>
      </a>
    </div>
  </section>
...
page("/services","services.html",
     "שירותים · פיתוח מוצר, ייעוץ ואוטומציה | מיכל בר",
     "שלושה תחומי שירות – פיתוח מוצרים ומערכות, ייעוץ עסקי וטכנולוגי, ואוטומציה של תהליכים. אפיון, עיצוב ופיתוח מקצה לקצה בליווי אישי.",
     [("דף הבית","/"),("שירותים",None)],
     svc_cards + faq_html + CTA,
     [{"@type":"ItemList","itemListElement":[
        {"@type":"ListItem","position":1,"url":SITE+"/services/product-development","name":"פיתוח מוצרים"},
        {"@type":"ListItem","position":2,"url":SITE+"/services/consulting","name":"ייעוץ עסקי וטכנולוגי"},
        {"@type":"ListItem","position":3,"url":SITE+"/services/automation","name":"אוטומציה ותהליכים"}]}, faq_s])
...
service_page("/services/consulting","services/consulting.html",
    ...
    "ייעוץ עסקי וטכנולוגי",
    "ייעוץ שמחבר בין עסק לטכנולוגיה – מיפוי צורך, אסטרטגיה ותכנון פתרון מדויק.")

service_page("/services/automation","services/automation.html",
    "אוטומציה לעסקים וייעול תהליכים | מיכל בר",
    "אוטומציה של תהליכים עסקיים – חיבור מערכות וכלים כך שפעולות ידניות חוזרות קורות מעצמן וחוסכות שעות עבודה.",
    "אוטומציה ותהליכים",
    "תהליכים חכמים שחוסכים זמן ידני ועובדים לבד – חיבור בין הכלים והמערכות שלכם כך שהעבודה החוזרת נעשית מעצמה.",
    ["כל שעה שאתם או הצוות מבזבזים על פעולות ידניות חוזרות היא שעה שאפשר להחזיר. אוטומציה עסקית מחברת בין הכלים והמערכות שלכם כך שהעברת נתונים, עדכונים, דוחות וטפסים קורים אוטומטית – בלי טעויות ובלי לגזול זמן.",
     "מתחילים במיפוי: איפה נשרף הכי הרבה זמן ידני, ומה ההזדמנויות הגדולות. משם בונים אוטומציות ממוקדות שמשתלבות בכלים שכבר יש לכם."],
    ["מיפוי תהליכים והזדמנויות לאוטומציה","אוטומציות עבודה שוטפות","חיבור בין כלים ומערכות (אינטגרציות)","דוחות, טפסים ועדכונים אוטומטיים","ייעול תפעולי וחיסכון בזמן"],
    ["עסקים שנשרף להם זמן על עבודה ידנית","צוותים שעובדים עם כמה מערכות שלא מדברות","מי שרוצה להקטין טעויות אנוש","עסקים שרוצים לגדול בלי לגדול בכוח אדם"],
    [("מה זה אוטומציה עסקית?","חיבור בין הכלים והמערכות שלכם כך שפעולות ידניות חוזרות קורות מעצמן – בלי טעויות ובלי לגזול זמן."),
     ("מה אפשר לאטמט?","כמעט כל תהליך חוזר: העברת נתונים בין מערכות, שליחת מיילים ועדכונים, יצירת דוחות, טפסים, גבייה ועוד."),
     ("כמה זמן חוסכים?","תלוי בתהליך – לקוחות חסכו מאות שעות עבודה בשנה. אחרי מיפוי נדע להצביע על ההזדמנויות הגדולות ביותר.")],
    "אוטומציה ותהליכים",
    "אוטומציה של תהליכים עסקיים – חיבור מערכות וייעול שחוסך שעות עבודה.")
...
contact_body = '''  <section class="wrap page-hero" style="text-align:center;">
    ...
    <p class="s-lead" style="margin-inline:auto;">שיחת היכרות ראשונית – ללא התחייבות. אחזור אליכם תוך 24 שעות.</p>
  </section>
  <section class="wrap">
    <div class="contact-grid">
      ...
      <form class="contact-form" id="contactForm" novalidate autocomplete="on">
        ...
        <div class="field"><label for="message">ההודעה</label>
        ...
        <button type="submit" class="btn1 form-submit">שליחה</button>
  ...
  document.addEventListener('DOMContentLoaded',function(){
    ...
    form.addEventListener('submit',function(e){e.preventDefault();
      ...
      if(!email){msg('err','אנא הזינו כתובת מייל');return;}
      if(!/^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/.test(email)){msg('err','כתובת מייל לא תקינה');return;}
