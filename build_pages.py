...
service_page("/services/product-development","services/product-development.html",
    ...
    ["בניית אתרים, אפליקציות ומערכות (Full-stack)","אפיון מוצר מתוך חשיבה עסקית","עיצוב חוויית משתמש וממשק (UX/UI)","מסרים נכונים ובידול","בניית MVP – גרסה ראשונה ממוקדת","מערכי תשלום, ניהול ודשבורדים","ליווי ושיתוף לאורך כל הדרך"],
