...
# ---- /services (hub) ----
svc_cards = '''  <section class="wrap page-hero" style="text-align:center;">
    <span class="eyebrow" style="justify-content:center;"><span class="idx">//</span> <span class="ttl">שירותים</span></span>
    <h1 class="s-head" style="margin-inline:auto;">פיתוח, אוטומציה וסוכני AI – מקצה לקצה</h1>
    <p class="s-lead" style="margin-inline:auto;">משלבת אסטרטגיה, אפיון מדויק, פיתוח, אוטומציה וסוכני AI בליווי אישי מההתחלה ועד התוצאה. שלושה תחומי שירות, גישה אחת: להבין את הצורך השורשי ולבנות את הפתרון הנכון.</p>
    <div class="prose" style="max-width:66ch;margin:20px auto 0;">
